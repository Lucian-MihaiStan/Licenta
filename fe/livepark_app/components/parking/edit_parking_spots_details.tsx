...
export const EditParkingSpotsDetailsForm = () => {
    ...
    const goToNextPage = async () => {
        const parkingId = parking_data.id;
        // modify the parking
        let url = GlobalConstants.PARKING_LINK + "/" + parkingId;
        ...
        if (!response.ok) {
            alert("Could not edit the parking.");
            return;
        }
        // modify the parking spots
        ...
        if (!response.ok) {
            alert("Could not edit the parking spots.");
            return;
        }

        alert("The parking was edited successfully.");
    ...
    return (
        <div className={styles.mainArea}>
            ...
            <button className={styles2.nextButton} onClick={goToNextPage}> Edit parking </button>
        </div>
    );
}